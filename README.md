...
Самый простой способ запустить сервис — использовать Docker. По умолчанию приложение настроено на сохранение файлов в директорию `/mnt/docker-data` на хост-машине.

### Требования

- Установленный Docker на целевом устройстве
